---
title: Deploying Other Frameworks (e.g., Strands, CrewAI)
sidebarTitle: Deploying Other Frameworks (e.g., Strands, CrewAI)
---
This guide shows how to leverage [Functional API](/oss/python/langgraph/functional-api) to deploy a Strands Agent on LangSmith Deployment and set up tracing for Observability. You can follow the same approach with other frameworks like CrewAI, AutoGen, Google ADK, etc.

Using Functional API and deploying to LangSmith Deployments provides several benefits:

* Production deployment: Deploy your integrated solution to [LangSmith Deployments](/langsmith/deployments) for scalable production use.
...
## 2. Use Functional API to Deploy on LangSmith Deployments
...
You can follow detailed guide [here](https://docs.langchain.com/langsmith/deploy-to-cloud) to deploy your agent.
