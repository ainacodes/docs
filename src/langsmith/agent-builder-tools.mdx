...
<Callout icon="circle-info" color="#DCFCE7" iconType="regular">
  Google, Slack, Linear, GitHub, and LinkedIn use OAuth. Exa, Tavily, and Twitter/X use workspace secrets. BigQuery and Google Sheets use Google OAuth. Pylon uses OAuth or server configuration.
</Callout>
