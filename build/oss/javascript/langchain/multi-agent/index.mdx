...
- **Tokens processed**: Total [context window](/oss/javascript/langchain/context-engineering) usage across all calls. More tokens = higher processing costs and potential context window pressure.
